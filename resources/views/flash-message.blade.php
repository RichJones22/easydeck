<div>
    @if($shown)
        <div id="{{ ($message['important'] ? 'dontAutoRemove' : ($message['dismissable'] ? 'autoRemove' : 'dontAutoRemove')) }}"
             class="rounded-r-md {{ $styles['bg-color'] }} p-4 border-l-4 {{ $styles['border-color'] }} mb-3">
            <div class="flex">
